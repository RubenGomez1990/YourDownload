...
/**
 * Configuration panel for application-wide settings.
 * Manages user preferences such as binary executable paths, temporary file storage,
 * and download speed limits using Java Preferences API.
...
public class PreferencesPanel extends javax.swing.JPanel {
    ...
    /**
     * Constructs a new PreferencesPanel.
     * Initializes components, loads saved user settings, and applies corporate styling.
     * @param mainScreen The parent application frame.
     * @param originalPanel The original content panel to restore when exiting.
     */
    ...
    /**
     * Handles the temporary path selection via a directory chooser.
     * @param evt The action event triggered by the choose button.
     */
    ...
    /**
     * Restores the original dashboard panel and resizes the window.
    ...
    /**
     * Updates and persists the selected speed limit index.
     * @param evt The action event triggered by the combo box selection.
     */
    ...
    /**
     * Handles the action event for the jCheckPlaylists.
    ...
    /**
     * Flushes the current preferences to ensure permanent storage in the system registry.
    ...
    /**
     * Helper method to transform a standard button into an icon-only interface element.
     * @param btn The button component to modify.
