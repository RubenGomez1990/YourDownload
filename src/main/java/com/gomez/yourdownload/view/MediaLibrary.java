...
/**
 * Interface panel that manages the media library. Provides functionality to
 * view, filter, download, upload, and delete media resources by synchronizing
 * local history with server data.
 *
...
public class MediaLibrary extends javax.swing.JPanel {
    ...
    /**
     * Reference to the previous panel for navigation.
     */
    private final JPanel originalPanel;
    /** 
     * List of all media resources available. 
     */
    private final List<DownloadInfo> resourcesList;
    /** 
     * Table model for managing the media data display. 
     */
    private DownloadInfoTableModel tableModel;
    /** 
     * Poller component for network synchronization. 
     */
    ...
    /**
     * Constructs the Media Library panel.
     * Initializes components, applies corporate styling, and loads initial media data.
     * @param principal The parent MainScreen instance.
     * @param originalPanel The previous panel to return to.
     * @param resourcesList The shared list of download information.
     * @param mediaPoller The poller instance for server communication.
     */
    ...
    /**
     * Navigates back to the original main dashboard view.
    ...
    /**
     * Deletes the selected media resource from the list and, if present, from local storage.
     * @param evt The action event.
     */
    ...
    /**
     * Downloads a selected cloud-only resource to the local machine.
     * @param evt The action event.
     */
...
// 1. Obtener la fila seleccionada de la vista
    ...
    /**
     * Uploads a local file to the cloud server using a manual multipart POST request.
     * @param evt The action event.
     */
    ...
    /**
     * Handles the action event for the jTextFieldSearch.
    ...
    /**
     * Sanitizes and extracts the media format from MIME types or filenames.
     * @param mimeType The MIME type provided by the server.
    ...
    /**
     * Executes a manual multipart/form-data upload to the API.
